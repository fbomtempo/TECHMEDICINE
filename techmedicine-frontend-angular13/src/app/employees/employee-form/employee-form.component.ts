...
export class EmployeeFormComponent extends FormService implements OnInit {
  ...
  private createForm(): void {
    ...
    this.form = this.formBuilder.group({
      ...
      surname: [employee.surname, [Validators.required, Validators.maxLength(50)]],
      ...
      cpf: [employee.cpf, [Validators.required, Validators.minLength(14), Validators.maxLength(14)]],
      homePhone: [employee.homePhone, [Validators.minLength(14), Validators.maxLength(14)]],
      mobilePhone: [employee.mobilePhone, [Validators.minLength(15), Validators.required, Validators.maxLength(15)]],
      email: [employee.email, [Validators.required, Validators.maxLength(35)]],
      cep: [employee.cep, [Validators.required, Validators.minLength(9), Validators.maxLength(9)]],
      city: [employee.city, [Validators.required, Validators.maxLength(30)]],
      state: [employee.state, [Validators.required]],
      address: [employee.address, [Validators.required, Validators.maxLength(70)]],
      number: [employee.number, [Validators.required, Validators.min(1), Validators.max(9999)]],
