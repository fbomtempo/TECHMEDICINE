...
public class SpecialtyResource {
	...
	@GetMapping
	public ResponseEntity<List<Specialty>> findAll(Sort sort) {
		List<Specialty> list = specialtyService.findAll(sort);
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/pageable")
	public ResponseEntity<Page<Specialty>> findAll(Pageable pageable, @RequestParam String filter) {
		Page<Specialty> page = specialtyService.findAll(pageable, filter);
