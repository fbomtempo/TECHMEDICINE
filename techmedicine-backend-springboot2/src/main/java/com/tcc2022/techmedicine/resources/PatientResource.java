...
public class PatientResource {
	...
	@GetMapping
	public ResponseEntity<List<Patient>> findAll(Sort sort) {
		List<Patient> list = patientService.findAll(sort);
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/pageable")
	public ResponseEntity<Page<Patient>> findAll(Pageable pageable, @RequestParam String filter) {
		Page<Patient> page = patientService.findAll(pageable, filter);
