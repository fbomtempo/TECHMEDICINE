...
public class EmployeeResource {
	...
	@GetMapping
	public ResponseEntity<List<Employee>> findAll(Sort sort) {
		List<Employee> list = employeeService.findAll(sort);
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/pageable")
	public ResponseEntity<Page<Employee>> findAll(Pageable pageable, @RequestParam String filter) {
		Page<Employee> page = employeeService.findAll(pageable, filter);
